...
void setup()
{
  ...
  CAN0.init_Mask(0,0,0x07E40000);                // Init first mask...
  CAN0.init_Filt(0,0,0x07E40000);                // Init first filter...
  CAN0.init_Filt(1,0,0x07E40000);                // Init second filter...
  
  CAN0.init_Mask(1,0,0x07E40000);                // Init second mask... 
  CAN0.init_Filt(2,0,0x07E40000);                // Init third filter...
  CAN0.init_Filt(3,0,0x07E40000);                // Init fourth filter...
  CAN0.init_Filt(4,0,0x07E40000);                // Init fifth filter...
  CAN0.init_Filt(5,0,0x07E40000);                // Init sixth filter...
